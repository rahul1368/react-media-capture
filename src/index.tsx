...
export default class Webcam extends React.Component<WebcamProps, WebcamState> {
  ...
  getCanvas(screenshotDimensions?: ScreenshotDimensions) {
    ...
    if (!this.ctx) {
      ...
      this.canvas.width = screenshotDimensions?screenshotDimensions.width: canvasWidth;
      this.canvas.height = screenshotDimensions?screenshotDimensions.height :canvasHeight;
    ...
    if (ctx && canvas) {
      ...
      ctx.drawImage(this.video, 0, 0, screenshotDimensions?screenshotDimensions.width : canvas.width, screenshotDimensions?screenshotDimensions.height : canvas.height);
